...
if (process.argv[2] !== 'keys') {
    if (cliArgs.hook) {
        ...
        const TOOLS = [
            ...
            {
                name: 'marrow_auto',
                description: 'Durably capture low-risk activity in one bounded call. Outcomes remain pending unless success is explicit; risky completion still requires a fresh gate and measured proof.',
                inputSchema: {
                    type: 'object',
                    properties: {
