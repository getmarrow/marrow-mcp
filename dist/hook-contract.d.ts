...
export declare const MCP_PACKAGE_SPEC = "@getmarrow/mcp@3.9.50";
export declare const CONTEXT_HOOK_COMMAND = "npx -y @getmarrow/mcp@3.9.50 context-hook";
export declare const PRE_ACTION_HOOK_COMMAND = "npx -y @getmarrow/mcp@3.9.50 pre-action-hook";
export declare const ACTION_RESULT_HOOK_COMMAND = "npx -y @getmarrow/mcp@3.9.50 hook";
export declare const SESSION_END_HOOK_COMMAND = "npx -y @getmarrow/mcp@3.9.50 session-hook";
