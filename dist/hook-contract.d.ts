...
export declare const PRE_ACTION_HOOK_COMMAND = "npx -y --package=@getmarrow/mcp@3.9.59 marrow-mcp pre-action-hook";
export declare const ACTION_RESULT_HOOK_COMMAND = "npx -y --package=@getmarrow/mcp@3.9.59 marrow-mcp hook";
export declare const SESSION_END_HOOK_COMMAND = "npx -y --package=@getmarrow/mcp@3.9.59 marrow-mcp session-hook";
